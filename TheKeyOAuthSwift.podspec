#
# Be sure to run `pod lib lint TheKeyOAuthSwift.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/ryan.t.carlson@cru.org/TheKeyOAuthSwift.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'TheKeyOAuthSwift' => ['TheKeyOAuthSwift/Assets/*.png']
  # }
